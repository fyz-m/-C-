...
using ExprNodePtr = std::variant<BinaryExprPtr, LiteralExprPtr, IdentifierExprPtr>;
...
template <typename T>
concept ExprType =
    std::same_as<T, BinaryExpr> || std::same_as<T, LiteralExpr> || std::same_as<T, IdentifierExpr>;
